                    ...
                    <div className="d-flex m-auto">
                        <ul className="navbar-nav me-auto gap-10 m-auto my-2 my-lg-0 navbar-nav-scroll d-flex gap-5">
                            <li className="nav-item m-auto">
                                <Link activeClass={"nav-link-active"} spy className="nav-link cursor-pointer home nav-link-text navigation-items" aria-current="page"
                                         to="home">Home</Link>
                            </li>
                            <li className="nav-item m-auto">
                                <Link className="nav-link explore nav-link-text navigation-items" to={"clients"}>
                                    About us</Link>
                            </li>
                            <li className="nav-item m-auto">
                                <Link className="nav-link contact nav-link-text navigation-items"
                            ...
                            <li className="nav-item ">
                                <Link
                                    className="nav-link contact nav-link-text navigation-items d-flex flex-column justify-content-center"
                                    to={"/contact"}
                                    to={"/quotes"}>
